...
const HowWeWork = () => {
    return (
        <div className="howWeWorkDiv">
            ...
            <p className="howWeWorkPoint">
                2. TSG Research and Design fee: Upon receiving and reviewing your request, we will
                ...
                reality. At this point, a non-refundable Research And Design Fee is charged as
                follows:
        </p>
            <p className="howWeWorkPoint">
            ...
            <p className="howWeWorkPoint">
                Custom curated FIT Itinerary: If trip planning involves multiple
                destinations or a complicated itinerary, we require a non-refundable
                Research and Design Fee starting at $200 per person to cover our time and expenses, as
            ...
            <p className="howWeWorkPoint">
                Groups: For groups of 10 or more, the non refundable Research and Design Fee and
                the length of time needed to book will be quoted based on the situation,
                size of the group, and occasion, but generally starts around $500 for the group or party.
        </p>
            <p className="howWeWorkPoint">
                ...
                bookings. We will be happy to make recommendations for you to book on
                your own free of charge. Should you wish to save the time, we will
                happily book those flights for a small convenience fee:
        </p>
            <p className="howWeWorkPoint">
                $100 per person / per flight for domestic flights
        </p>
            <p className="howWeWorkPoint">
                $200 per person / per flight for international flights
        </p>
            ...
            <p className="howWeWorkPoint">
                Once you have selected your agent and have sent in your request and R&D
                Fee, you will receive our Vacation Questionaire or have a follow up
                call scheduled with one of our experienced advisors. This can also be
            ...
            <p className="howWeWorkPoint">
                1. Complete the Questionaire: Sit down with a coffee or your expert and
            ...
            <p className="howWeWorkPoint">
                ...
                put together then come home and let us know all about it. Of course,
            ...
            <p className="howWeWorkPoint">
                ...
                We will provide you with a custom quote with every trip
                booked. If you don’t receive one, please call your agent within 48 hours
