	...
	const teamProfiles = [
		{
			...
			favDest:
				'Her favorite destinations: Way too many to name them all but Bora Bora, Anguilla, Hawaii, Switzerland Antigua, St Lucia, and Mexico top the list.',
